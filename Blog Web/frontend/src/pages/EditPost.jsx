  ...
  return (
    <div>
      ...
      <form className="w-full flex flex-col space-y-4 md:space-y-8">
       ...
       {loader?<Loader/> : <textarea onChange={(e)=>setDesc(e.target.value)} value={desc} rows={10} cols={30} placeholder='Enter post description' className='px-4 py-2 outline-none'/>}
